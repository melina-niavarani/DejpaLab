...
import { FileText, Calendar, User, Mail, Phone, CheckCircle, Upload } from 'lucide-react';
...
export default function RequestTestPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Test request submitted:', formData);
    setIsSubmitted(true);
    setTimeout(() => {
  ...
  const testTypes = [
    t('testTypes.chemical'),
    t('testTypes.physical'),
    t('testTypes.microbiology'),
    t('testTypes.environmental'),
    t('testTypes.custom'),
  ];
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="border-b border-gray-200 pb-6 mb-6">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                    <User className="w-6 h-6 mr-3 rtl:mr-0 rtl:ml-3 text-primary-600" />
                    {t('personalInfo')}
                  </h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label htmlFor="preferredDate" className="block text-sm font-semibold text-gray-700 mb-2">
                        <Calendar className="w-4 h-4 inline mr-2 rtl:mr-0 rtl:ml-2" />
                        {t('preferredDate')}
                      </label>
                      <input
                        type="date"
                  ...
                  <div className="space-y-6">
                    <div>
                      <label htmlFor="testType" className="block text-sm font-semibold text-gray-700 mb-2">
                        {t('testType')} <span className="text-red-500">*</span>
                      </label>
                      <select
                        id="testType"
                        name="testType"
